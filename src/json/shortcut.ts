			...
			children: [
...

				{
					name: translate('popupShortcutNavigation'), children: [
						...
						{ id: 'space4', name: U.Common.sprintf(translate('popupShortcutMainBasics27'), 4), keys: [ cmdKey, '4' ] },
						{ id: 'space5', name: U.Common.sprintf(translate('popupShortcutMainBasics27'), 5), keys: [ cmdKey, '5' ] },
						{ id: 'space6', name: U.Common.sprintf(translate('popupShortcutMainBasics27'), 6), keys: [ cmdKey, '6' ] },
						{ id: 'space7', name: U.Common.sprintf(translate('popupShortcutMainBasics27'), 7), keys: [ cmdKey, '7' ] },
						{ id: 'space8', name: U.Common.sprintf(translate('popupShortcutMainBasics27'), 8), keys: [ cmdKey, '8' ] },
						{ id: 'space9', name: U.Common.sprintf(translate('popupShortcutMainBasics27'), 9), keys: [ cmdKey, '9' ] },
